...
func getConnection() *grpc.ClientConn {
	conn, err := tb.NewGrpcClientConnectionInsecure(viper.GetString("server.host"), viper.GetString("server.port"))
...
var rootCmd = &cobra.Command{
	Use:   "tb-client",
	Short: "A client to run commands on the tb-server",
}
